    ...
    <footer className="bg-card/50 border-t border-border mt-20 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1 space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Accountability gamified. Win the pool by committing to your goals.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 text-muted-foreground">
              ...
              <a target="_blank" href="https://www.instagram.com/olisrabs_/" className="hover:text-primary transition-colors">
        ...
        <div className="border-t border-border mt-12 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} MoveUp. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
